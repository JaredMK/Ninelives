...
enum BuildStamp {
    static let version = "v5.79"
    static let note = "ios: swipe rail state fixes + popup removed, deck inspect shows remaining/full + on-card stickers + hold help, identical pack cards fixed"
