...
export function run() {
  ...
  // NOTE: the Stats-screen histogram MODEL (the ZEN6 single-node-set, three-state
  // expand/contract) is asserted in tests/zen6.test.mjs. Here we keep only the
  // ZEN2/ZEN3 contracts (unlock ladder + per-game end overlay + recording).
