...
const NINELIVES_ITEMS = {
  ...
  stickers: [
    ...
    { id: "rankUp2", unlock: { type: "milestone", stat: "dealsSurvived", count: 9 },    label: "+2 Rank",     icon: "⏫", kind: "rank",     rankDelta: 2,  tier: "uncommon", price: 2,
      description: "+2 card rank (stops at Ace)." },
    { id: "rankDown2", unlock: { type: "milestone", stat: "dealsSurvived", count: 57 },  label: "−2 Rank",     icon: "⏬", kind: "rank",     rankDelta: -2, tier: "uncommon", price: 2,
      description: "-2 card rank (stops at 2)" },
    { id: "randomFixedValue", unlock: { type: "milestone", stat: "runsPlayed", count: 4 }, label: "Random Rank", icon: "🎰", kind: "behavior", behavior: "randomFixedValue", tier: "uncommon", price: 1,
    ...
    { id: "suitImmunity", unlock: { type: "milestone", stat: "dealsSurvived", count: 105 }, label: "Spade Guard", icon: "♠️🪬", kind: "behavior", behavior: "suitImmunity", suit: "♠", tier: "uncommon", price: 6,
      description: "Safe if this card lands on a ♠, or a ♠ lands on this card" },
    { id: "heartGuard", unlock: { type: "milestone", stat: "coinsEarnedLifetime", count: 243 }, label: "Heart Guard", icon: "♥️🪬", kind: "behavior", behavior: "suitImmunity", suit: "♥", tier: "uncommon", price: 6,
      description: "Safe if this card lands on a ♥, or a ♥ lands on this card" },
    { id: "diamondGuard", unlock: { type: "behavior", stat: "pilesLost", count: 43 }, label: "Diamond Guard", icon: "♦️🪬", kind: "behavior", behavior: "suitImmunity", suit: "♦", tier: "uncommon", price: 3,
      description: "Safe if this card lands on a ♦, or a ♦ lands on this card" },
    { id: "clubGuard", unlock: { type: "behavior", stat: "cardsBuried", count: 57 },  label: "Club Guard",  icon: "♣️🪬", kind: "behavior", behavior: "suitImmunity", suit: "♣", tier: "uncommon", price: 3,
      description: "Safe if this card lands on a ♣, or a ♣ lands on this card" },
    ...
    { id: "twoTribute", unlock: { type: "behavior", stat: "cardsBuried", count: 117 }, label: "Bury 2",      icon: "⚰️", kind: "behavior", behavior: "tribute", tributeCount: 2, coinCost: 7, tier: "rare", price: 16,
    ...
    { id: "heavy",      label: "Heavy",       icon: "🧱", kind: "behavior", behavior: "heavy", value: 1, tier: "common", price: 2,
     ...
     { id: "massive", unlock: { type: "behavior", stat: "stickersApplied", count: 7 },      label: "Massive",       icon: "🧱", kind: "behavior", behavior: "heavy", value: 2, tier: "uncommon", price: 4,
      description: "When placed → +2 toward pile size",suits: ["♦"]  },
    { id: "collector", unlock: { type: "behavior", stat: "stickersApplied", count: 88 },  label: "Collector",   icon: "🧲", kind: "behavior", behavior: "collector", value: 2, tier: "uncommon", price: 2,
    ...
    { id: "compound", unlock: { type: "milestone", stat: "dealsSurvived", count: 165 },   label: "Compound",    icon: "📈", kind: "behavior", behavior: "compound", step: 1, tier: "rare", price: 2,
    ...
    { id: "shuffle", unlock: { type: "milestone", stat: "runsPlayed", count: 5 },    label: "Shuffle",     icon: "🔀", kind: "behavior", behavior: "shuffle", tier: "uncommon", price: 2,
    ...
    { id: "quickBury", unlock: { type: "behavior", stat: "cardsBuried", count: 9 },  label: "Quick Bury",  icon: "⚡", kind: "behavior", behavior: "quickBury", tier: "uncommon", price: 7,
      description: "When this card lands → bury 1 deck card under the pile", suits: ["♣"]  },
    ...
    { id: "looseChange", unlock: { type: "milestone", stat: "coinsEarnedLifetime", count: 153 }, label: "Loose Change", icon: "🪙", kind: "behavior", behavior: "looseChange", max: 3, tier: "uncommon", price: 4,
      description: "When this card lands → +0–3 coins (random)", suits: ["♥"] },
    // step = how much X (cards buried) grows per correct placement.
    { id: "snowball", unlock: { type: "behavior", stat: "cardsBuried", count: 177 },   label: "Snowball Bury", icon: "☃️", kind: "behavior", behavior: "snowball", step: 1, tier: "rare", price: 20,
    ...
    { id: "deepPockets", unlock: { type: "milestone", stat: "coinsEarnedLifetime", count: 1053 }, label: "Deep Pockets", icon: "👛", kind: "behavior", behavior: "deepPockets", per: 10, tier: "uncommon", price: 2,
      description: "When this card lands → +1 coin per 10 cards left in the deck", suits: ["♥"]},
    { id: "pillarScout", unlock: { type: "behavior", stat: "pillarsPlaced", count: 14 }, label: "Pillar Scout", icon: "🔭", kind: "behavior", behavior: "pillarScout", tier: "uncommon", price: 3,
      description: "When this card lands → peek at the next card if this column has no pillar", suits: ["♠"]  },
    { id: "baseScout", unlock: { type: "behavior", stat: "basesPlaced", count: 15 },  label: "Base Scout",  icon: "🔎", kind: "behavior", behavior: "baseScout", tier: "uncommon", price: 3,
    ...
    { id: "heartSnob", unlock: { type: "milestone", stat: "coinsEarnedLifetime", count: 603 },  label: "Heart Snob",  icon: "💞", kind: "behavior", behavior: "heartSnob", value: 4, tier: "uncommon", price: 2,
      description: "When a ♥ lands on this card → +4 coins"},
    { id: "diamondSnob", unlock: { type: "behavior", stat: "removalsUsed", count: 12 }, label: "Diamond Snob", icon: "💎", kind: "behavior", behavior: "diamondSnob", tier: "uncommon", price: 5,
      description: "When a ♦ lands on this card → shuffle all piles"},
    // digCount = deck cards buried under the pile per Club Snob.
    { id: "clubSnob", unlock: { type: "behavior", stat: "cardsBuried", count: 69 },   label: "Club Snob",   icon: "🍀", kind: "behavior", behavior: "clubSnob", digCount: 1, tier: "uncommon", price: 10,
    ...
    { id: "heartChoir", unlock: { type: "milestone", stat: "dealsSurvived", count: 141 }, label: "Heart Choir", icon: "💕", kind: "behavior", behavior: "heartChoir", value: 1, tier: "uncommon", price: 6,
      description: "When this card lands → +1 coin per other pile with a ♥ top card", suits: ["♥"] },
    { id: "diamondRipple", unlock: { type: "milestone", stat: "runsPlayed", count: 9 }, label: "Diamond Ripple", icon: "🌊", kind: "behavior", behavior: "diamondRipple", tier: "uncommon", price: 3,
    ...
    { id: "clubRoots", unlock: { type: "behavior", stat: "cardsBuried", count: 201 }, label: "Club Roots", icon: "🌱", kind: "behavior", behavior: "clubRoots", digCount: 1, tier: "rare", price: 15,
    ...
    { id: "rechargeSameShield", unlock: { type: "behavior", stat: "correctSames", count: 9 }, label: "Recharge Shield", icon: "🛡️", kind: "behavior", behavior: "rechargeSameShield", tier: "rare", price: 15,
      description: "When this card lands correctly → bank a Same Charge (max 1)" },
    { id: "activateSamePower", unlock: { type: "behavior", stat: "correctSames", count: 36 }, label: "Tap Power", icon: "🔗", kind: "behavior", behavior: "activateSamePower", tier: "rare", price: 12,
  ...
  pillars: [
    ...
    { id: "columnTieSafe", unlock: { type: "behavior", stat: "samesCalled", count: 14 }, label: "Column Tie-Safe", icon: "🛡️",
    ...
    { id: "clubTribute", unlock: { type: "behavior", stat: "cardsBuried", count: 105 }, label: "8 Bury", icon: "8️⃣",
    ...
    { id: "streakBank", unlock: { type: "milestone", stat: "dealsSurvived", count: 153 }, label: "Streak Size", icon: "🏦",
    ...
    { id: "streakTribute", unlock: { type: "behavior", stat: "cardsBuried", count: 153 }, label: "Streak Bury", icon: "🔥",
    ...
    { id: "secondWind", unlock: { type: "behavior", stat: "pilesLost", count: 27 }, label: "Second Wind", icon: "🌬️",
    ...
    { id: "fibonacci", unlock: { type: "milestone", stat: "bossesBeaten", count: 18 }, label: "Fibonacci", icon: "🌀",
    ...
    { id: "highestEven", unlock: { type: "milestone", stat: "coinsEarnedLifetime", count: 963 }, label: "Highest Heart", icon: "💗",
    ...
    { id: "denseBury", unlock: { type: "behavior", stat: "stickersApplied", count: 97 }, label: "Dense Bury", icon: "🧊",
    ...
    { id: "revive", unlock: { type: "milestone", stat: "bossesBeaten", count: 6 }, label: "Revive", icon: "♻️",
    ...
    { id: "prime", unlock: { type: "milestone", stat: "bossesBeaten", count: 30 }, label: "Prime", icon: "🔢",
    ...
    { id: "excavator", unlock: { type: "behavior", stat: "cardsBuried", count: 189 }, label: "Excavator", icon: "⛏️",
    ...
    { id: "lastRites", unlock: { type: "behavior", stat: "pilesLost", count: 47 }, label: "Last Rites", icon: "🕯️",
    ...
    { id: "wildAces", unlock: { type: "behavior", stat: "jokersPlayed", count: 10 }, label: "Wild Aces", icon: "🃏",
      kind: "guess", effect: "wildAces", tier: "rare", price: 25,
      description: "Aces count as high or low when landing in this column" },
    { id: "diamondAnchor", unlock: { type: "milestone", stat: "dealsSurvived", count: 177 }, label: "Diamond Anchor", icon: "⚓",
    ...
    { id: "diamondDistribution", unlock: { type: "behavior", stat: "removalsUsed", count: 24 }, label: "Diamond Distribution", icon: "⚖️",
  ...
  bases: [
    ...
    { id: "kamikaze", unlock: { type: "milestone", stat: "bossesBeaten", count: 21 }, label: "Kamikaze", icon: "💥",
    ...
    { id: "revive", unlock: { type: "behavior", stat: "pilesLost", count: 7 }, label: "Phoenix", icon: "🔥",
    ...
    { id: "setSuit", unlock: { type: "milestone", stat: "runsWon", count: 6 }, label: "Suit Setter", icon: "🎨",
    ...
    { id: "stickerHarvest", unlock: { type: "behavior", stat: "stickersApplied", count: 79 }, label: "Sticker Harvest", icon: "🌾",
    ...
    { id: "refreshBases", unlock: { type: "behavior", stat: "basesPlaced", count: 31 }, label: "Reactor", icon: "⚛️",
    ...
    { id: "clubDig", unlock: { type: "behavior", stat: "cardsBuried", count: 165 }, label: "Club Dig", icon: "♣️",
    ...
    { id: "demolish", unlock: { type: "behavior", stat: "pillarsPlaced", count: 19 }, label: "Demolish", icon: "🔨",
    ...
    { id: "heartDemolish", unlock: { type: "behavior", stat: "pilesLost", count: 51 }, label: "Heart Demolish", icon: "💔",
    ...
    { id: "rechargeSame", unlock: { type: "behavior", stat: "correctSames", count: 33 }, label: "Recharge Cell", icon: "🔋",
      kind: "active", effect: "rechargeSameShield", tier: "rare", price: 25,
      description: "Bank a Same Charge (max 1)" },
    { id: "activateSame", unlock: { type: "behavior", stat: "correctSames", count: 42 }, label: "Power Surge", icon: "⚡",
  ...
  samePowers: [
    ...
    { id: "linkCoins", label: "Dividend", icon: "💰",
      effect: "linkCoins", value: 2, tier: "rare", price: 5,
      description: "Trigger: You make a correct Same\nEffect: Gain 2 coins for each alive pile on the board" },
    ...
    { id: "linkHeavy", unlock: { type: "behavior", stat: "correctSames", count: 39 }, label: "Same Heavy", icon: "🧱",
      effect: "linkHeavy", value: 2, hubValue: 5, tier: "rare", price: 5,
      description: "Trigger: You make a correct Same\nEffect: Add +2 pile size to every alive pile, and another +5 to the pile you called Same on" },
  ],
  ...
  -------------------------------------------------------------------- */
  packs: [
    { id: "cardPack", unlock: { type: "milestone", stat: "dealsSurvived", count: 117 }, label: "Large Card Pack", icon: "🎴", kind: "card", tier: "uncommon",
    ...
    { id: "largeStickerPack", unlock: { type: "behavior", stat: "stickersApplied", count: 52 }, label: "Large Sticker Pack", icon: "📦", kind: "sticker", tier: "common",
