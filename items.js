...
const NINELIVES_ITEMS = {
  ...
  stickers: [
    ...
    { id: "extraCoin",  label: "Payout",      icon: "💰", kind: "behavior", behavior: "extraCoin", value: 1, tier: "uncommon", price: 2,
      description: "Earn coins equal to pile size if this card is top of pile at end of deal" },
    { id: "middleColumnReward", label: "Middle", icon: "🎯", kind: "behavior", behavior: "middleColumnReward", value: 3, tier: "uncommon", price: 2,
      description: "+3 coins if in middle column" },
    ...
    { id: "anchor",     label: "Anchor",      icon: "⚓", kind: "behavior", behavior: "anchor", tier: "common", price: 3,
      description: "If this is the top card, the pile is left out of the smallest-pile score" },
    ...
    { id: "heavy",      label: "Heavy",       icon: "🧱", kind: "behavior", behavior: "heavy", value: 1, tier: "common", price: 2,
      description: "+1 toward pile size" },
    { id: "collector",  label: "Collector",   icon: "🧲", kind: "behavior", behavior: "collector", value: 1, tier: "uncommon", price: 2,
      description: "+1 coin per other sticker on this card" },
    ...
    { id: "compound",   label: "Compound",    icon: "📈", kind: "behavior", behavior: "compound", step: 1, tier: "rare", price: 2,
      description: "Earn X coins. X starts at 0 and grows by 1 after each correct placement" },
    { id: "revealNext", label: "Scout",       icon: "👁️", kind: "behavior", behavior: "revealNext", tier: "rare", price: 12,
      description: "Peek at the next deck card" },
    ...
    { id: "shuffle",    label: "Shuffle",     icon: "🔀", kind: "behavior", behavior: "shuffle", tier: "uncommon", price: 2,
      description: "Optionally shuffle the pile" },
    ...
    { id: "donate",     label: "Donate",      icon: "🤝", kind: "behavior", behavior: "donate", count: 1, tier: "common", price: 1,
      description: "Move 1 buried card from pile card is placed on to the smallest pile" },
    ...
    { id: "quickBury",  label: "Quick Bury",  icon: "⚡", kind: "behavior", behavior: "quickBury", peelChance: 0.25, tier: "uncommon", price: 7,
      description: "Bury 1 deck card under the pile, then a 25% chance this sticker peels" },
    { id: "twinSpark",  label: "Twin Spark",  icon: "✨", kind: "behavior", behavior: "twinSpark", tier: "rare", price: 5,
      description: "Peek next card if the top card of another pile has the same rank as this card" },
    ...
    { id: "looseChange", label: "Loose Change", icon: "🪙", kind: "behavior", behavior: "looseChange", max: 3, tier: "uncommon", price: 4,
      description: "+0–3 coins random each time" },
    // step = how much X (cards buried) grows per correct placement.
    { id: "snowball",   label: "Snowball Bury", icon: "☃️", kind: "behavior", behavior: "snowball", step: 1, tier: "rare", price: 10,
      description: "Bury X cards under the pile. X starts at 0 and grows by 1 each correct placement. A wrong guess resets it to 0." },
    ...
    { id: "deepPockets", label: "Deep Pockets", icon: "👛", kind: "behavior", behavior: "deepPockets", per: 10, tier: "uncommon", price: 2,
      description: "+1 coin per 10 cards left in the deck" },
    { id: "pillarScout", label: "Pillar Scout", icon: "🔭", kind: "behavior", behavior: "pillarScout", tier: "uncommon", price: 3,
      description: "Peek at the next deck card if this card lands in column with no Pillar" },
    { id: "baseScout",  label: "Base Scout",  icon: "🔎", kind: "behavior", behavior: "baseScout", tier: "uncommon", price: 3,
      description: "Peek at the next card if in a column with no Base" },
    { id: "suitSnob",   label: "Suit Snob",   icon: "🧐", kind: "behavior", behavior: "suitSnob", tier: "uncommon", price: 3,
      description: "Peek at next deck card if this card lands on above a card of the same suit" },
    ...
    { id: "momentum",   label: "Momentum",    icon: "🎢", kind: "behavior", behavior: "momentum", step: 2, tier: "rare", price: 2,
      description: "Earn X coins. X starts at 0 and grows by 2 after each correct placement. An incorrect guess resets X to 0" },
    { id: "tell",       label: "Tell",        icon: "🔮", kind: "behavior", behavior: "tell", tier: "uncommon", price: 7,
      description: "Tells you if the next drawn card is higher, lower, or same as this card" },
  ...
  bases: [
    ...
    { id: "spadePeek", label: "Spade Peeker", icon: "🔦",
      ...
      description: "Trigger: Activated, once per deal\nEffect: Peek the next X upcoming cards, where X is the number of piles in this column with a ♠ top card" },
